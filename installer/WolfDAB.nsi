Unicode True
Name "WolfDAB"
OutFile "${__FILEDIR__}\..\..\..\releases\WolfDAB-Trial-Setup-x64.exe"
...
VIAddVersionKey /LANG=1033 "ProductVersion" "1.0.17 Trial"
VIAddVersionKey /LANG=1033 "FileVersion" "1.0.17 Trial"
...
Section "WolfDAB" SEC_MAIN
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\WolfDAB" "DisplayVersion" "1.0.17 Trial"
